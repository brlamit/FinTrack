...
<head>
    ...
    <style>
        ...
        body.theme-light #force-theme-toggle {
...
<body class="hero-bg min-h-screen flex items-center justify-center px-4 py-10 relative">
    ...
    <div class="w-full max-w-md mx-auto relative z-10">
        <header class="mb-8 flex items-center justify-between">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-slate-400">Set a new password</p>
                </div>
            </div>

            <button id="force-theme-toggle" type="button" class="px-3 py-1.5 rounded-full text-[11px] bg-slate-900/70 border border-slate-700/70 text-slate-200 hover:bg-slate-800/80 transition">
                Light mode
            </button>
        </header>
        ...
        <main class="glass p-6 sm:p-7">
            <div class="mb-6">
                ...
                <p class="text-xs text-slate-400">For your security, please choose a fresh password before continuing.</p>
            </div>
            ...
            <form method="POST" action="{{ route('auth.force-password-change.post') }}" class="space-y-4 text-sm">
                ...
                <div>
                    <label for="password" class="block mb-1 text-xs font-medium text-slate-300">New Password</label>
                    <input
                        type="password"
                        id="password"
                        name="password"
                ...
                <div>
                    <label for="password_confirmation" class="block mb-1 text-xs font-medium text-slate-300">Confirm New Password</label>
                    <input
                        type="password"
    ...
    <script>
        (function () {
            ...
            var storageKey = 'fintrack-force-theme';
            var toggle = document.getElementById('force-theme-toggle');
